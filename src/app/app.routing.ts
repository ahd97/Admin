...
const arr:Routes=[
    ...
    {path:'purchase_detail',component:PurchaseDetailComponent},
    {path:'purchase_order',component:PurchaseOrderComponent},
    {path:'purchase_order_detail',component:PurchaseOrderDetailComponent},
    {path:'purchase_payment',component:PurchasePaymentComponent},
    {path:'purchase_return',component:PurchaseReturnComponent},
    {path:'purchase_return_detail',component:PurchaseReturnDetailComponent},
    {path:'role',component:RoleComponent},
    {path:'sales',component:SalesComponent},
    {path:'sales_detail',component:SalesDetailComponent},
    {path:'sales_order',component:SalesOrderComponent},
    {path:'sales_order_detail',component:SalesOrderDetailComponent},
    {path:'sales_payment',component:SalesPaymentComponent},
    {path:'sales_return',component:SalesReturnComponent},
    {path:'sales_return_detail',component:SalesReturnDetailComponent},
    {path:'supplier',component:SupplierComponent},
    {path:'add_sales_order',component:AddSalesOrderComponent},
    {path:'add_sales_order_detail',component:AddSalesOrderDetailComponent},
    {path:'add_color',component:AddColorComponent},
    {path:'add_design',component:AddDesignComponent},
    {path:'add_image',component:AddImageComponent},
    {path:'add_product_category',component:AddProductCategoryComponent},
    {path:'add_purchase',component:AddPurchaseComponent},
    {path:'add_purchase_detail',component:AddPurchaseDetailComponent},
    {path:'add_purchase_order',component:AddPurchaseOrderComponent},
    {path:'add_purchase_order_detail',component:AddPurchaseOrderDetailComponent},
    {path:'add_purchase_payment',component:AddPurchasePaymentComponent},
    {path:'add_purchase_return',component:AddPurchaseReturnComponent},
    {path:'add_purchase_return_detail',component:AddPurchaseReturnDetailComponent},
    {path:'add_role',component:AddRoleComponent},
    {path:'add_supplier',component:AddSupplierComponent},
    {path:'update_product/:p_id',component:UpdateproductComponent},
    {path:'add_sales_payment',component:AddSalesPaymentComponent},
    {path:'add_sales_return',component:AddSalesReturnComponent},
    {path:'add_sales_return_detail',component:AddSalesReturnDetailComponent},
    {path:'add_user',component:AddUserComponent},
    {path:'update_product_category/:p_id',component:UpdateProductCategoryComponent},
    {path:'update_sales/:s_id',component:UpdateSalesComponent},
    {path:'update_color/:c_id',component:UpdateColorComponent},
    {path:'update_city/:c_id',component:UpdateCityComponent},
    {path:'update_design/:d_id',component:UpdateDesignComponent},
    {path:'update_image/:i_id',component:UpdateImageComponent},
    {path:'update_role/:r_id',component:UpdateRoleComponent},
    {path:'update_supplier/:s_id',component:UpdateSupplierComponent},
    {path:'update_purchase/:p_id',component:UpdatePurchaseComponent},
    {path:'update_purchase_detail/:p_id',component:UpdatePurchaseDetailComponent},
    {path:'update_purchase_order/:p_id',component:UpdatePurchaseOrderComponent},
    {path:'update_purchase_order_detail/:p_id',component:UpdatePurchaseOrderDetailComponent},
    {path:'update_purchase_payment/:p_id',component:UpdatePurchasePaymentComponent},
    {path:'update_purchase_return/:p_id',component:UpdatePurchaseReturnComponent},
    {path:'update_purchase_return_detail/:p_id',component:UpdatePurchaseReturnDetailComponent},
    {path:'update_sales_detail/:s_id',component:UpdateSalesDetailComponent},
    {path:'update_sales_order/:s_id',component:UpdateSalesOrderComponent},
    {path:'update_sales_order_detail/:s_id',component:UpdateSalesOrderDetailComponent},
    {path:'update_sales_payment/:s_id',component:UpdateSalesPaymentComponent},
    {path:'update_sales_return/:s_id',component:UpdateSalesReturnComponent},
    {path:'update_sales_return_detail/:s_id',component:UpdateSalesReturnDetailComponent},
    {path:'update_user/:u_id',component:UpdateUserComponent},
    {path:'view_user/:u_id',component:ViewUserComponent},
    {path:'view_supplier/:s_id',component:ViewSupplierComponent},
    {path:'view_sales_return_detail/:s_id',component:ViewSalesReturnDetailComponent},
    {path:'view_sales_return/:s_id',component:ViewSalesReturnComponent},
    {path:'view_sales_payment/:s_id',component:ViewSalesPaymentComponent},
    {path:'view_sales_order_detail/:s_id',component:ViewSalesOrderDetailComponent},
    {path:'view_sales_order/:s_id',component:ViewSalesOrderComponent},
    {path:'view_sales_detail/:s_id',component:ViewSalesDetailComponent},
    {path:'view_sales/:s_id',component:ViewSalesComponent},
    {path:'view_role/:r_id',component:ViewRoleComponent},
    {path:'view_purchase_return_detail/:p_id',component:ViewPurchaseReturnDetailComponent},
    {path:'view_purchase_return/:p_id',component:ViewPurchaseReturnComponent},
    {path:'view_purchase_payment/:p_id',component:ViewPurchasePaymentComponent},
    {path:'view_purchase_order_detail/:p_id',component:ViewPurchaseOrderDetailComponent},
    {path:'view_purchase_order/:p_id',component:ViewPurchaseOrderComponent},
    {path:'view_purchase_detail/:p_id',component:ViewPurchaseDetailComponent},
    {path:'view_purchase/:p_id',component:ViewPurchaseComponent},
    {path:'view_product_category/:p_id',component:ViewProductCategoryComponent},
    {path:'view_product/:p_id',component:ViewProductComponent},
    {path:'view_image/:i_id',component:ViewImageComponent},
    {path:'view_color/:c_id',component:ViewColorComponent},
